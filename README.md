...
`master_supervisor` adalah referensi immutable baseline HY 2026. Form publik hanya membacanya dan tidak pernah mengubah atau menghapus baris master.

```text
master_supervisor (immutable HY 2026 reference)
        |
...
| `GOOGLE_MASTER_SUPERVISOR_SPREADSHEET_ID` | Spreadsheet master HY 2026 |
